...
export const FinanceOverviewReportDashboard: FC = () => {
  const i18n = useI18n();
  ...
  const { data, isLoading, isFetching, isError } =
    apiSlice.endpoints.getFinanceOverviewReport.useQuery({
      startDate:
        queries[FinanceOverviewReportQueriesEnum.startDate] ?? undefined,
      endDate: queries[FinanceOverviewReportQueriesEnum.endDate] ?? undefined,
    });
